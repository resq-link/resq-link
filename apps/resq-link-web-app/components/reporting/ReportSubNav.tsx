...
const tabs = [
  { href: routes.commandCenter.report, label: 'Analytics Dashboard', icon: BarChart3, exact: true },
  { href: routes.commandCenter.reportIncidents, label: 'Incident Reports & Export', icon: FileSpreadsheet, exact: false },
]
