...
import type { IncidentRecord, ResourceRecord, TeamRecord } from '@packages/firebase'
...
export default function AgentAssistant({ defaultOpen = false }: { defaultOpen?: boolean }) {
  const { user } = useAuth()
  const pathname = usePathname()
  const { incidents, resources } = useDispatcherData()
