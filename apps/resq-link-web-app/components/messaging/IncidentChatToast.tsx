    ...
    >
      {toasts.map((toast) => (
        <div
          key={toast.id}
          role="status"
          className="pointer-events-auto animate-in fade-in slide-in-from-bottom-2 duration-200 rounded-xl border border-sky-500/40 bg-slate-900/95 px-3.5 py-3 text-sm shadow-xl backdrop-blur-md"
        >
          <div className="flex items-start gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 line-clamp-2 text-sm leading-snug text-slate-300">{toast.message}</p>
            </div>
            <button
              type="button"
