...
import { CheckCircle2, ClipboardPlus, MessageSquareMore, Send, ShieldAlert, XCircle } from "lucide-react";
import ProtectedRoute from "@/components/ProtectedRoute";
import { useAuth } from "@/contexts/AuthContext";
import { subscribeToSmsIntakes, subscribeToSmsMessages, type SmsIntake, type SmsIntakeStatus, type SmsMessage } from "@packages/firebase";

const QUICK_REPLIES = [
  "Thank you for contacting RESQ-Link. Please share your exact location or nearest landmark.",
  "For dispatch, please tell us what happened, how many people are involved, and whether anyone is injured or in immediate danger.",
  "We are reviewing your report. If there is immediate danger, call 911 or your local emergency number now.",
];
