            ...
            <section className="min-h-0 flex-1 rounded-xl border border-slate-800 bg-slate-900/70 p-3 shadow-md shadow-black/10">
              ...
              {isLoading ? (
                <div className="py-12 text-center">
                  <div className="inline-block h-7 w-7 animate-spin rounded-full border-b-2 border-primary-500" />
                  <p className="mt-3 text-sm text-slate-400">Loading incident data…</p>
                </div>
              ) : !hasGeneratedReport ? (
