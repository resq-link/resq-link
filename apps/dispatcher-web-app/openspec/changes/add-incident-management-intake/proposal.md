...
## Why
The dispatcher web app currently uses a mock intake screen and does not enforce the command center's incident routing rules. The incident module needs a real Firestore-backed flow that applies the SPUP incident taxonomy and mandatory agency recommendations.
...
- Enforce mandatory agency routing from the SPUP incident subtype catalog.
