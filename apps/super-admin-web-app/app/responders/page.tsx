...
export default function RespondersPage() {
  ...
  const [dispatchers, setDispatchers] = useState<Array<{ id: string; email: string; role: string; active: boolean }>>([]);
      ...
      <div className="max-w-4xl">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400">Create and manage responder (dispatcher) accounts</p>
          </div>
        </div>
