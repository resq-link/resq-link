...
export function getStatusPresentation(status, theme, isLight = false) {
  ...
  const map = {
    ...
    active: {
      ...
      bg: isLight ? "rgba(2, 132, 199, 0.1)" : "rgba(56, 189, 248, 0.16)",
      border: isLight ? "rgba(2, 132, 199, 0.3)" : "rgba(56, 189, 248, 0.4)",
    ...
    on_scene: {
      ...
      bg: isLight ? "rgba(5, 150, 105, 0.1)" : "rgba(52, 211, 153, 0.16)",
      border: isLight ? "rgba(5, 150, 105, 0.3)" : "rgba(52, 211, 153, 0.4)",
