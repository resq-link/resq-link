...
import { getMapTheme, MAP_DARK_STYLE, MAP_LIGHT_STYLE } from "@/theme";
 ...
 */
export default function ResponderMapExplorer() {
  ...
  const sheetPanGesture = useMemo(
    () =>
      Gesture.Pan()
        /**
         * Require deliberate vertical motion before pan activates — taps and stationary
         * touches never run onUpdate/onEnd, so the sheet never moves without a drag.
         */
        .activeOffsetY([-12, 12])
        .failOffsetX([-40, 40])
        .onStart(() => {
        ...
        .onEnd((e) => {
          ...
          sheetMax.value = withSpring(dest, { damping: 20, stiffness: 200 });
        }),
            ...
            <GestureDetector gesture={sheetPanGesture}>
              ...
              >
                ...
                <View
                  style={[
                    styles.sheetInner,
                    styles.sheetEmptyScrollContent,
                  ]}
                >
