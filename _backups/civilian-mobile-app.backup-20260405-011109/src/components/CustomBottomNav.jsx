...
export default function CustomBottomNav() {
  ...
  // usePathname() is often "" or unstable during hydration; combine with segments so we never
  // show the bottom bar on the welcome screen (it would cover the full-width CTA).
  let p = "/";
  ...
  const isLandingOrAuth =
    p === "/" ||
    p === "/index" ||
    hideNavScreens.some((screen) => p === screen || p.endsWith(screen));
