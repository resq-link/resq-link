...
export default function RegisterScreen() {
  ...
  const handleSendCode = async () => {
    ...
    try {
      ...
      const { signInUserWithPhone } = await import("@packages/firebase/civilian-auth");
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      const { verifyPhoneCodeAndCreateProfile } = await import("@packages/firebase/civilian-auth");
