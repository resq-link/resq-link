...
const NATIVE_ALIASES = {
  // Legacy deep paths used by some deps; polyfill uses the public TextInput API.
  "react-native/Libraries/Components/TextInput/TextInput": path.resolve(
    __dirname,
...
// Ensure Metro can resolve the shared Firebase package (package root → package.json "main" → dist/)
config.resolver = {
  ...config.resolver,
  // Add support for .cjs files (required for Firebase)
  sourceExts: [...(config.resolver?.sourceExts || []), "cjs"],
  // Disable unstable package exports resolution (fixes Firebase / subpath resolution in monorepos)
